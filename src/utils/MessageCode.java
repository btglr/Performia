...
public enum MessageCode {
    ...
    GET_LIST_CHALLENGE(REQUEST, HTTP, 6,"Request sent by the web interface to get the list of challenges"),
    ...
    LIST_CHALLENGE(RESPONSE, HTTP, 508, "Answer sent by the HTTP server with the list of challenges"),
